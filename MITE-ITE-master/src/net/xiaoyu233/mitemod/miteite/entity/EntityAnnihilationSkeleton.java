...
public class EntityAnnihilationSkeleton extends EntitySkeleton {
    ...
    protected void applyEntityAttributes() {
        ...
        this.setEntityAttribute(GenericAttributes.attackDamage, boneLordTweak ? 13D + (double)day / 5D : 16.0D);
        this.setEntityAttribute(GenericAttributes.maxHealth, boneLordTweak ? 40D + (double)day / 3D : 25.0D);
    }
