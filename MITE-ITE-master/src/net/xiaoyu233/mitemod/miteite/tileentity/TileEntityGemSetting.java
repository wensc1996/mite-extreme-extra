...
public class TileEntityGemSetting extends TileEntity implements IWorldInventory {
    ...
    {
//        for (int i = 0; i< Item.gem1Phase.getSubItems().size() ; i++) {
//            this.setInventorySlotContents(i+1, new ItemStack(Item.gem1Phase, 1, i));
//        }
    }
